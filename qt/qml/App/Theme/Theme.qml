...
QtObject {
    ...
    readonly property color messageSelectionBg: "#5f4fa3"
    readonly property color messageSelectionText: "#fffaf0"
    readonly property color codeBlockBg: "#0f0e0c"
    readonly property color codeBlockHeaderBg: "#171511"
    readonly property color codeBlockBorder: "#353128"
    ...
    readonly property int messageVerticalGap: 24
