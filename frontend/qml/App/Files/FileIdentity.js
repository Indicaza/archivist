...
var definitionsByExtension = {
    ...
    ".less": identity("code", "Less", "less", "language-less", "{}", "plain-text"),
    ...
    ".java": identity("code", "Java", "java", "language-java", "{}", "plain-text"),
    ".kt": identity("code", "Kotlin", "kotlin", "language-kotlin", "{}", "plain-text"),
    ".kts": identity("code", "Kotlin Script", "kotlin", "language-kotlin", "{}", "plain-text"),
    ".swift": identity("code", "Swift", "swift", "language-swift", "{}", "plain-text"),
    ".php": identity("code", "PHP", "php", "language-php", "{}", "plain-text"),
    ...
    ".cmake": identity("code", "CMake", "cmake", "language-cmake", "{}", "plain-text"),
...
".doc": identity("document", "Word Document", "", "file-word", "▤", "pdf"),
".docx": identity("document", "Word Document", "", "file-word", "▤", "pdf"),
".odt": identity("document", "OpenDocument Text", "", "file-document", "▤", "pdf"),
".rtf": identity("document", "Rich Text Document", "", "file-document", "▤", "pdf"),
".xls": identity("spreadsheet", "Excel Spreadsheet", "", "file-excel", "▦", "pdf"),
".xlsx": identity("spreadsheet", "Excel Spreadsheet", "", "file-excel", "▦", "pdf"),
".ods": identity("spreadsheet", "OpenDocument Spreadsheet", "", "file-spreadsheet", "▦", "pdf"),
".ppt": identity("presentation", "PowerPoint Presentation", "", "file-powerpoint", "▣", "pdf"),
".pptx": identity("presentation", "PowerPoint Presentation", "", "file-powerpoint", "▣", "pdf"),
".odp": identity("presentation", "OpenDocument Presentation", "", "file-presentation", "▣", "pdf"),
...
var definitionsByLanguage = {
    ...
    "go": identity("code", "Go", "go", "language-go", "{}", "plain-text"),
    "java": identity("code", "Java", "java", "language-java", "{}", "plain-text"),
    "kotlin": identity("code", "Kotlin", "kotlin", "language-kotlin", "{}", "plain-text"),
    "swift": identity("code", "Swift", "swift", "language-swift", "{}", "plain-text"),
    "php": identity("code", "PHP", "php", "language-php", "{}", "plain-text"),
    "c": identity("code", "C", "c", "language-c", "{}", "plain-text"),
    "cpp": identity("code", "C++", "cpp", "language-cpp", "{}", "plain-text"),
